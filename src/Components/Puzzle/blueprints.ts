...
export const BLUEPRINTS: Record<string, Blueprint> = {
  ...
  corridor: {
    ...
    color: COLORS.orange,
    message:
      "You enter a long, narrow corridor.  The other door looks to be slightly ajar.",
    keys: 1,
    gems: 0,
    doors: 1,
    directions: [],
  ...
  guest_bedroom: {
    ...
    color: COLORS.purple,
    message:
      "You enter a two-bed guest bedroom with pictures of boats and sailing models on the the shelves.",
    keys: 0,
    gems: 1,
    doors: 0,
    directions: [],
  ...
  kitchen: {
    ...
    color: COLORS.yellow,
    message:
      "You find a kitchen with a large kitchen island and a food bowl filled with cat food.",
    keys: 1,
    gems: 0,
    doors: 1,
    directions: [],
  ...
  laboratory: {
    ...
    color: COLORS.blue,
    message:
      "You open the door revealing a science laboratory, complete with flasks, burners, and a periodic table on the wall.",
    keys: 0,
    gems: 1,
    doors: 1,
    directions: [],
  ...
  lavatory: {
    ...
    draftable: true,
    color: COLORS.red,
    message: "You find a small lavatory with absolutely nothing inside.",
    keys: 0,
    gems: 0,
    doors: 0,
    directions: [],
  ...
  nook: {
    ...
    color: COLORS.blue,
    message:
      "You find a reading nook with a comfy table and a large-scale rook piece on a shelf.",
    keys: 1,
    gems: 0,
    doors: 1,
    directions: [],
  ...
  nursery: {
    ...
    color: COLORS.purple,
    message:
      "You find a nursery with two cribs and baby toys covering the floor.",
    keys: 0,
    gems: 2,
    doors: 0,
    directions: [],
  ...
  observatory: {
    ...
    draftable: true,
    color: COLORS.blue,
    message: "You find a room containing a huge stargazing telescope.",
    keys: 0,
    gems: 1,
    doors: 1,
    directions: [],
  ...
  office: {
    ...
    color: COLORS.blue,
    message:
      "You enter a quiet office with a large desk, as well as a safe and busts of a certain 'Count Isaac Gates'.",
    keys: 1,
    gems: 0,
    doors: 1,
    directions: [],
  ...
  pantry: {
    ...
    color: COLORS.blue,
    message:
      "You come across a pantry with four gold coins and a banana sitting on the counter.",
    keys: 1,
    gems: 0,
    doors: 1,
    directions: [],
